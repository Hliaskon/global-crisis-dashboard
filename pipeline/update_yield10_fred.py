...
# -*- coding: utf-8 -*-
"""
Fetch 10Y government bond yields (OECD/FRED mirror).
Usage: python pipeline/update_yield10_fred.py <ISO2> <out_csv>
Example: python pipeline/update_yield10_fred.py US yield10_us.csv
"""
import os, sys
import requests
import pandas as pd
...
def main():
    if len(sys.argv) < 3:
        print("Usage: update_yield10_fred.py <ISO2> <out_csv>")
        sys.exit(2)
